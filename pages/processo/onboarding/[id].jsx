...
class Form extends Component {
  ...
  render() {
    ...
    const videoConstraints = {
      width: 1280,
      height: 720,
      facingMode: this.state.alterarCam ? { exact: "environment" } : "user",
    };
        ...
        <div className="680y col">
          ...
          {this.state.modalSubmit ? (
            ...
            >
              ...
              <b className="center">Formulário enviado com sucesso.</b>
              <br />
              <div className="2s 5p">
                <button
            ...
            >
              ...
              <details>
                ...
                <div className="row">
                  ...
                  <p id="adm" style={{ marginTop: "0", marginLeft: "5px" }}></p>
                </div>

                <div className="row">
                  <b>Bem:</b>
                  <p id="bem" style={{ marginTop: "0", marginLeft: "5px" }}></p>
                </div>
