            ...
            <div>
              {this.state.InvalidImage >= 1 ? (
                ...
                >
                  ...
                  <b className="center">
                    Cadastro finalizado, os dados estão em análise
                  </b>
                  <br />
                  <div className="2s 5p">
                    <button
                ...
                <div
                  ...
                  style={{ width: "600px" }}
                >
                  <h1 className="center">Fotos inválidas</h1>
                  <b className="center">Por favor, tire as fotos novamente.</b>
                  <br />
                  <div className="2s 5p">
                    <button
                      className="100w 10p 5r"
